...
'		<article class="post_content">'
			...
			<div class="post_info infoPost">
				...
				<?php } ?>
				<?php _e('Posted ', 'themerex'); ?><a href="<?php echo $post_data['post_link']; ?>" class="post_date date updated" itemprop="datePublished" content="<?php echo get_the_date('Y-m-d'); ?>"><?php echo $post_data['post_date']; ?></a>
				<span class="separator">|</span>
				<?php _e('by', 'themerex'); ?> <span class="vcard" itemprop="author"><a href="<?php echo $post_data['post_author_url']; ?>" class="post_author fn" rel="author"><?php echo $post_data['post_author']; ?></a></span>
