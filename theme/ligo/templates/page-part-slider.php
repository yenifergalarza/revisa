...
if (get_custom_option('slider_show')=='yes') { 
	...
	if (!empty($slider_alias) || !empty($slider_ids)) {
		?>
		<div class="sliderHomeBullets <?php echo get_custom_option('slider_display')=='fullscreen' ? '' : 'staticSlider'; ?> slider_engine_<?php echo $slider; ?> slider_alias_<?php echo $slider_alias; ?>">
			<?php
				if ($slider == 'revo') {
