...
// AJAX parameters
<?php global $THEMEREX_ajax_url; ?>
var THEMEREX_ajax_url = "<?php echo $THEMEREX_ajax_url; ?>";
var THEMEREX_ajax_nonce = "<?php echo esc_attr(wp_create_nonce('ajax_nonce')); ?>";
...
var THEMEREX_vc_edit_mode = <?php echo (isset($_GET['vc_editable']) && $_GET['vc_editable']=='true') || (isset($_GET['vc_action']) && $_GET['vc_action']=='vc_inline') ? 'true' : 'false'; ?>;
