...
?>
	<section class="author vcard<?php echo get_custom_option("show_post_related") == 'yes' || get_custom_option("show_post_comments") == 'yes' ? ' hrShadow' : ''; ?>" itemprop="author" itemscope itemtype="http://schema.org/Person">
		<h2 class="post_author_title"><?php echo __('About author', 'themerex'); ?> <span itemprop="name"><a href="<?php echo $post_data['post_author_url']; ?>" class="fn"><?php echo $post_data['post_author']; ?></a></span></h2>
		<div class="avatar"><a href="<?php echo $post_data['post_author_url']; ?>" itemprop="image"><?php echo $post_author_avatar; ?></a></div>
		<div class="authorInfo" itemprop="description"><p><?php echo $post_author_descr; ?></p></div>
		<?php if ($post_author_socials!='') { ?><div class="socPage"><ul><?php echo $post_author_socials; ?></ul></div><?php } ?>
	</section>
<?php
}
?>
