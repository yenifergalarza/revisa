...
function sc_contact_form($atts, $content = null) {
	...
	global $THEMEREX_ajax_url, $THEMEREX_sc_contact_form_counter, $THEMEREX_sc_contact_form_id;
...
function sc_gap_wrapper($str) {
	...
	$str_new = preg_replace('/(<div\s+class="[^"]*wpb_row[^>]*>)[\r\n\s]*(<div\s+class="[^"]*wpb_column[^>]*>)[\r\n\s]*(<div\s+class="[^"]*vc_column-inner[^>]*>)[\r\n\s]*(<div\s+class="[^"]*wpb_wrapper[^>]*>)[\r\n\s]*('.sc_gap_start().')/i', '\\5\\1\\2\\3\\4', $str);
