...
define( 'NOTIFIER_XML_FILE', themerex_get_protocol() . '://themerex.net/!updates/updates_grecko.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
