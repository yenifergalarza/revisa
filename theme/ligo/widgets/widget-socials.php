...
class themerex_social_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'logo_image' ); ?>" name="<?php echo $this->get_field_name( 'logo_image' ); ?>" value="<?php echo esc_attr($logo_image); ?>" style="width:100%;" onchange="jQuery(this).siblings('img').get(0).src=this.value;" />
            <?php
			...
			if ($logo_image) {
			?>
	            <br /><br /><img src="<?php echo $logo_image; ?>" width="220" alt="" />
			<?php
			}
			?>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'logo_text' ); ?>"><?php _e('Logo text:', 'themerex'); ?></label>
			<input id="<?php echo $this->get_field_id( 'logo_text' ); ?>" name="<?php echo $this->get_field_name( 'logo_text' ); ?>" value="<?php echo esc_attr($instance['logo_text']); ?>" style="width:100%;" />
		</p>
		<p>
